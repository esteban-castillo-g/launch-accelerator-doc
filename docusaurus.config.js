...
const config = {
  title: 'Launch Accelerator Program',
  tagline: 'Accelerate Your Journey with Databricks',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/databricks/launch-accelerator/tree/main/docs/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/databricks/launch-accelerator/tree/main/blog/',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/databricks/launch-accelerator',
            label: 'GitHub',
            position: 'right',
          },
        ],
